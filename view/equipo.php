...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- Buscar por nombre -->
        <?php searchBy("equipo", "Nombre", "Buscar", "nombre", "Buscar") ?>

        <!-- Buscar por codigo -->
        <?php searchBy("equipo", "Codigo de barras", "Buscar", "codigo_barras", "Buscar") ?>

        <!-- Agregar material -->
        <?php addBy("equipo", "Nuveo material", "Nuevo Equipo") ?>
    </div>
    <!-- BOTONES -->
